...
public class RunicArtifactOnHitEvent extends RunicItemArtifactTriggerEvent {
     ...
     */
    public RunicArtifactOnHitEvent(Player player, RunicItemArtifact runicItemArtifact, ItemStack itemStack,
